...
import 'package:coin_currency/presentation/widgets/home/calculator/clear_all_input_button.dart';
import 'package:coin_currency/presentation/widgets/home/calculator/simple_number_button.dart';
import 'package:coin_currency/presentation/widgets/home/calculator/single_backspace_button.dart';
...
class _NumKeyboardWidgetState extends State<NumKeyboardWidget> {
  ...
  void _refreshAnimation(value) {
    setState(() {
      tappedList.removeWhere((element) => element == value);
    });
  }
}
